# M8.py - Calendar Month Program: Indication of Leap Year
#
# Modify the  nal version of the Calendar Month program in section 3.5 
# so that for leap years, the month heading is displayed as in the following,
#
# (Photo Deleted)
#
# date:    10/02/2016
