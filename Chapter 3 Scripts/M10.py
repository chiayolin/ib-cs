# M10.py - Calendar Month Program: Day of the Week Headings
#
# Modify the final version of the Calendar Month program in section 3.5 so that
# there is day heading for each of the columns as shown below
#
# (Photo Deleted)
#
# date:    10/02/2016
...
while not terminate:
    ...
    if month == -1:
        ...
        # display a row for the days of week (HACK!)
