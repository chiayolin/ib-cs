# M6.py - Coin Change Exercise Program: Addition of Half-Dollar Coins
#
# Modify the Coin Change Exercise program in section 3.4.6 to allow for the use
# of half-dollar coins. Make all necessary changes in the program.
# 
# date:    10/03/2016
# author:  n/a
# license: n/a
