# insulter.py - Shakespeare Insulter
# 
# Combine one word from each of the three list below, prefaced with "Thou".
# This script is inspired by MIT's Shakespeare Insult Kit:
...
col_1 = [ "artless", "bawdy", "beslubbering", "bootless", "churlish", 
...
col_2 = [ "base-court", "bat-fowling", "beef-witted", "beetle-headed", 
...
col_3 = [ "apple-john", "baggage", "barnacle", "bladder", "boar-pig", "bugbear", 
...
print("Thou", col_1[randint(0, len(col_1) - 1)],
              col_2[randint(0, len(col_2) - 1)],
              col_3[randint(0, len(col_3) - 1)] + '.')
