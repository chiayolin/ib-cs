...
#
# Modify the Password Encryption/Decryption program in the chapter so 
# that it allows the user to continue to encrypt and decrypt passwords 
# until they quit.
#
# date:    11/07/2016
# author:  n/a
