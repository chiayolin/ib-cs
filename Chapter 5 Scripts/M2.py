# M2.py - GPA Calculation Program: Accommodating First-Semester Students
#
# Modify the GPA Calculation program in section 5.2.7 so that it asks the 
# student if this is their first semester. If so, the program should only 
# prompt for their current semester grades, and not their cumulative GPA 
# and total earned credits, and display their semester GPA and cumulative 
# GPA accordingly.
#
# date:    12/01/2016
# author:  n/a
